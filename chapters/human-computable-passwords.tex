...
\begin{table}
    ...
    \begin{tabular}{ |c|l| }
        \hline
    $f(x_0,\dots,x_{13})$ & \begin{tabular}{@{}l@{}}A human computable function used in the password\\ management scheme investigated in this project.\\ Defined in \autoref{f-function} \end{tabular}  \\
        \hline
...
\subsection{Security parameters} \label{sec-params}
...
\todo[inline]{discuss how failure rates affect the usability}
