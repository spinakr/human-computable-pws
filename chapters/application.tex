...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{new-site-dialog} 
    \caption{Screen as seen by the user after launching the extensions while on a page without stored challenges. After clicking the "Add site"-button, the next view shows the generated challenges. The user should then calculate the response and change the password of the site to match it.}
    \label{launch-screen}
\end{figure}
