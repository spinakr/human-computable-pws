...
\newglossaryentry{9}{name={Content script}, description={A script which is injected in the page loaded in the browser, can monitor fields and user activity, but does not have the permissions of the user. Used in the project to monitor the URL and password fields of active sites}}
