...
\begin{table}
    ...
    \caption{\cite{hcp-blocki} Extra rehearsals required of the user during the first year to remember $\sigma$ as seen definition \ref{fo-function}.}
\end{table}
